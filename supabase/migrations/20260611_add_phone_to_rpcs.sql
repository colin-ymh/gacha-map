-- Add phone to all shop listing RPC functions

DROP FUNCTION IF EXISTS public.get_shops_by_score(double precision, double precision, double precision, double precision, integer, integer, uuid);
