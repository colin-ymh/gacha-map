  ...
  try {
    ...
    const msg = await claude.messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `가샤폰 기계 패널 OCR 텍스트에서 상품 시리즈 라벨, IP명, 제조사를 추출하세요. JSON만 반환:\n{"series_label":"상품 형태 시리즈 라벨—반드시 일본어로 반환(예:おねむたん、肩ズン、こっちむいて、ぺっとねじまき、ぐにゃっと 등, 없으면null)","ip_name":"IP·원작명(예:ぼっち・ざ・ろっく!、ハイキュー!!、チェンソーマン、鬼滅の刃、呪術廻戦—모르면null)","manufacturer":"제조사(BANDAI/TAKARA TOMY 등,모르면null)"}\n\n시리즈 라벨 한국어→일본어 변환 힌트:\n돌아봐/이쪽봐/코치무이테→こっちむいて / 어깨/어깨위/카타즌→肩ズン / 잠자/잠드는/오네무→おねむたん / 꾸백/구냐→ぐにゃっと / 넬/넬네지마키→ぺっとねじまき\n\n캐릭터→IP 힌트: 고조사토루·나나미켄토·게토스구루·하이바라유우·五条悟→呪術廻戦 / 히나타·카게야마·우카이·스가와라→ハイキュー!! / 탄지로·네즈코·젠이쓰·이노스케·竈門→鬼滅の刃 / 봇치·키타·山田·伊地知→ぼっち・ざ・ろっく! / 파워·마키마·아카네→チェンソーマン\n\nOCR:\n${fullText.slice(0, 800)}`,
        },
      ],
    });
